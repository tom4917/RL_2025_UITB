...
if __name__=="__main__":
  ...
  parser.add_argument('--r2_regularisation', type=float, help='use r2 regularisation during training')
  parser.add_argument('--r1_regularisation', type=float, help='use r1 regularisation during training')
  ...
  #env = rl_algo.env 
  if args.r2_regularisation is not None and args.r1_regularisation is None:
      task._set_regularisation(rl_model, args.r2_regularisation, True)
      print("R2 Regularisation activted")

  if args.r1_regularisation is not None and args.r2_regularisation is None:
      task._set_regularisation(rl_model, args.r1_regularisation, False)
      print("R1 Regularisation activted")
